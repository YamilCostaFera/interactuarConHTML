...
bienvenida.innerText = 'Hola ' + cliente + '!! Bienvenidos a DULCE PASTELERIA!';
...
while (inicio != '8') {
    switch (inicio) {
        ...
        case '7':
            ...
            console.log(tortas);
            let ordenar = document.getElementById(pedido_1);
            ordenar.innerText = tortas;
            break;
    ...
    pedido.push(saldo);
    let parcial = pedido;
    let carrito = document.getElementById('pedir');
    carrito.innerText = 'El valor de las tortas seleccionadas es de: '+parcial;
